...
import com.argonmobile.odinapp.util.Utilities;
 ...
 */
public class TaskStackView extends FrameLayout implements ViewPool.ViewPoolConsumer<TaskView, Profile>,
        TaskStackViewScroller.TaskStackViewScrollerCallbacks, TaskView.TaskViewCallbacks {
...
//                ctx.updateListener = mRequestUpdateClippingListener;
    ...
    public void prepareViewToLeavePool(TaskView tv, Profile task, boolean isNewView) {
        Log.e("SD_TRACE", "prepareViewToLeavePool........");
    ...
    public void onTaskViewClicked(TaskView tv, Profile task) {
        if (mCb != null) {
            mCb.onTaskViewClicked(this, tv, task);
        }
    }
}
